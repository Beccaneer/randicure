  ...
  def update
	...
	def populate
    	...
    	@id = current_user.id
			...
			Colour.create(colourfam: 'Red', user_id: @id)
			Colour.create(colourfam: 'Blue', user_id: @id)
			Colour.create(colourfam: 'Green', user_id: @id)
			Colour.create(colourfam: 'Yellow', user_id: @id)
			Colour.create(colourfam: 'Orange', user_id: @id)
			Colour.create(colourfam: 'Purple', user_id: @id)
			Colour.create(colourfam: 'White', user_id: @id)
			Colour.create(colourfam: 'Black', user_id: @id)
