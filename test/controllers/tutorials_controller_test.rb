...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { author: @tutorial.author, image: @tutorial.image, title: @tutorial.title, url: @tutorial.url }
    end
  ...
  test "should update tutorial" do
    patch :update, id: @tutorial, tutorial: { author: @tutorial.author, image: @tutorial.image, title: @tutorial.title, url: @tutorial.url }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
