...
class TechesControllerTest < ActionController::TestCase
  ...
  test "should create tech" do
    assert_difference('Tech.count') do
      post :create, tech: { maxaccents: @tech.maxaccents, maxcol: @tech.maxcol, minaccents: @tech.minaccents, mincol: @tech.mincol, title: @tech.title }
    end
  ...
  test "should update tech" do
    patch :update, id: @tech, tech: { maxaccents: @tech.maxaccents, maxcol: @tech.maxcol, minaccents: @tech.minaccents, mincol: @tech.mincol, title: @tech.title }
    assert_redirected_to tech_path(assigns(:tech))
  end
